document.addEventListener('DOMContentLoaded', (e) => {
    ...
    function setEmpty(bodyTable){
        if(bodyTable.querySelectorAll('tr').length === 0){
            bodyTable.insertAdjacentHTML('beforeend', `<h2 id="empty" class="position-absolute start-50 translate-middle-x mt-3">Table is Empty!</h2>`);
        }
        else{
    ...
    paramsDefault.addButton.onclick = (e) => {
        e.preventDefault();
    ...
    exitParams.form.onsubmit = (e) => {
        ...
        window.location.href = 'http://localhost:63342/laba4/auth/login/login.php';
    }
